...
class Booking(Base):
    ...
    original_rate_plan_id = Column(
        UUID(as_uuid=True), ForeignKey("rate_plans.id"))
    ...
    changes = relationship(
        "BookingChange", back_populates="booking", cascade="all, delete")
    cancellations = relationship(
        "BookingCancellation", back_populates="booking", cascade="all, delete")
