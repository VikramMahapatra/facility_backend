...
from ...schemas.service_ticket.tickets_schemas import TicketCreate, TicketDetailsResponse, TicketFilterRequest, TicketOut
...
def get_ticket_details_route(
    ...
    """
    return crud.get_ticket_details(db, auth_db, ticket_id)
