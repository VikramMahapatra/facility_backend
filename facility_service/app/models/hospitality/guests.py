...
class Guest(Base):
    ...
    booking_changes = relationship("BookingChange", back_populates="changed_by_guest")
    cancellations_made = relationship("BookingCancellation", back_populates="cancelled_by_guest")
